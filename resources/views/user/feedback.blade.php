            ...
            <div class="row">
                <div class="select_maps col-md-12 col-sm-12 col-xs-12 ">
                    ...
                    <div class="card-header">
                        <h3 class="card-title p-l-400  mt-2 mb-2 text-center" style="color: RGB(15,74,146); font-weight: bold; font-size: 25px">GÓP Ý_ĐÓNG GÓP</h3>
                    </div>
                    <form action="/user/feedback/{{auth('web')->user()->id}}" method="POST">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
